...
public class PersonOverviewController {
    ...
    private void handleDeletePerson() {
        ...
        if (selectedIndex >= 0) {
        	...
        	// Delete the person, call the deletePerson(perID) method in the DAL
    ...
    private void handleNewPerson() {
        ...
        if (okClicked) {
        	...
        	// Delete the person, call the addPerson(perID) method in the DAL
    ...
    private void handleEditPerson() {
        ...
        if (selectedPerson != null) {
            ...
            if (okClicked) {
            	...
            	// Delete the person, call the updatePerson(perID) method in the DAL
